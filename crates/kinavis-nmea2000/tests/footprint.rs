...
fn the_assembler_and_the_messages_stay_within_their_budgets() {
    // MAX_ASSEMBLIES fast packets in flight, up to 223 bytes each.
    within::<kinavis_nmea2000::Assembler>(2560);
    within::<kinavis_nmea2000::Message>(128);
    within::<kinavis_nmea2000::Frame>(16);
}
